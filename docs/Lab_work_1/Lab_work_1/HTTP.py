...
Приклад: HTTP in python: GET, POST, PUT, DELETE
...
def POST_test (url: str) -> None:
    ...
    # інформація, що надається до серверу
...
if __name__ == '__main__':
    ...
    print('4 - Парсинг табличних даних https://index.minfin.com.ua/ua/labour/wagemin/')
    mode = int(input('mode:'))
    ...
    if (mode == 4):
        print('Обрано: Парсинг табличних даних https://index.minfin.com.ua/ua/labour/wagemin/')
        url_DS = 'https://index.minfin.com.ua/ua/labour/wagemin/'
